...
cases='success write adjacent-before adjacent-after close max-transaction request-before request-misaligned request-generation
...
printf '%s\n' 'Payload-MM FMP dispatch O0/O2/ASan+UBSan hostile cases: PASS'
