...
{
	static const char *const required_driver[] = {
	...
	static char required_driver_name[80];
	...
	if (id >= 0x1b00 && id < 0x1b00 + 2 * ARRAY_SIZE(required_driver)) {
		const char *operation = id & 1U ? "returned" : "begin";

		snprintf(required_driver_name, sizeof(required_driver_name),
			 "CDK2 %s dispatch %s", required_driver[(id - 0x1b00) / 2U],
			 operation);
		return required_driver_name;
	}
	...
	case 0x1355: return "CDK2 BDS USB scan begin";
	case 0x1356: return "CDK2 BDS USB scan timeout";
	case 0x1357: return "CDK2 BDS USB scan end";
	...
	case 0x1680: return "CDK2 DXE initial free memory";
	case 0x1681: return "CDK2 setup boot media unavailable";
	case 0x1682: return "CDK2 capsule scan location";
	case 0x1683: return "CDK2 display framebuffer";
	case 0x1684: return "CDK2 console interface counts";
	case 0x1685: return "CDK2 loader interrupt restore";
	case 0x1686: return "CDK2 loader services result";
	case 0x1687: return "CDK2 setup ESP selection";
	case 0x1688: return "CDK2 loader resource cleanup";
	case 0x1689: return "CDK2 ready-to-boot cleanup";
	case 0x168a: return "CDK2 loader image unload";
	case 0x168b: return "CDK2 loader image return";
