...
.PHONY: test-authvar-presence-abi
...
.PHONY: test-authvar-presence-producer
...
.PHONY: test-capsule-tpm-platform-anchor
test-capsule-tpm-platform-anchor:
	tests/lib/capsule_tpm_anchor_platform_test.sh
	tests/lib/capsule_tpm_anchor_trusted_transition_test.sh
	tests/lib/capsule_tpm_anchor_test.sh
...
.PHONY: test-capsule-platform-facts
test-capsule-platform-facts:
	tests/lib/efi_fw_info_test.sh
