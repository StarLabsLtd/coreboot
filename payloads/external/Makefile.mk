...
# The EDK2 wrapper uses these platform selections to choose payload defaults.
# Keep the forwarding explicit so the payload does not have to rediscover the EC.
EDK2_EC_PROFILE_ARGS = \
	CONFIG_BOARD_EMULATION_QEMU_X86_Q35=$(CONFIG_BOARD_EMULATION_QEMU_X86_Q35) \
	CONFIG_EC_STARLABS_MERLIN=$(CONFIG_EC_STARLABS_MERLIN) \
	CONFIG_EC_GOOGLE_CHROMEEC=$(CONFIG_EC_GOOGLE_CHROMEEC)
...
EDK2_PAYLOAD_ARGS = \
	...
	CONFIG_MAX_CPUS=$(CONFIG_MAX_CPUS) \
	CONFIG_EDK2_USE_EDK2_PLATFORMS=$(CONFIG_EDK2_USE_EDK2_PLATFORMS) \
	CONFIG_EDK2_PLATFORMS_REPOSITORY=$(CONFIG_EDK2_PLATFORMS_REPOSITORY) \
	CONFIG_EDK2_PLATFORMS_TAG_OR_REV=$(CONFIG_EDK2_PLATFORMS_TAG_OR_REV) \
	CONFIG_EDK2_DEBUG=$(CONFIG_EDK2_DEBUG) \
	...
	CONFIG_EDK2_SPI_FLASH_LOGGING=$(CONFIG_EDK2_SPI_FLASH_LOGGING) \
	...
	CONFIG_EDK2_CDK2_HPET_TIMER=$(CONFIG_EDK2_CDK2_HPET_TIMER) \
...
EDK2_CDK2_BACKEND_ARGS =
ifeq ($(CONFIG_EDK2_CDK2_BACKEND_NATIVE),y)
EDK2_CDK2_BACKEND_ARGS += CDK2_BACKEND=native
EDK2_CDK2_BACKEND_ARGS += CDK2_PAYLOAD_FV="$(abspath $(call strip_quotes,$(CONFIG_EDK2_CDK2_PAYLOAD_FV)))"
endif
...
$(obj)/cdk2-coreboot-image.elf: $(DOTCONFIG) payloads/external/edk2/Makefile $(objutil)/kconfig/conf
	$(MAKE) -C payloads/external/edk2 cdk2 \
		...
		CONFIG_EDK2_CDK2_BACKEND_NATIVE=$(CONFIG_EDK2_CDK2_BACKEND_NATIVE) \
		CONFIG_EDK2_CDK2=$(CONFIG_EDK2_CDK2) \
		CONFIG_EDK2_DEBUG=$(CONFIG_EDK2_DEBUG) \
		CONFIG_EDK2_CPU_TIMER_LIB=$(CONFIG_EDK2_CPU_TIMER_LIB) \
		CONFIG_EDK2_CUSTOM_BUILD_PARAMS=$(CONFIG_EDK2_CUSTOM_BUILD_PARAMS) \
		...
		CONFIG_SMMSTORE=$(CONFIG_SMMSTORE) \
		CONFIG_EDK2_SECURE_BOOT_SUPPORT=$(CONFIG_EDK2_SECURE_BOOT_SUPPORT) \
		CONFIG_EDK2_CDK2_SETUP_UI=$(CONFIG_EDK2_CDK2_SETUP_UI) \
		CONFIG_EDK2_CDK2_LVGL_RENDERER=$(CONFIG_EDK2_CDK2_LVGL_RENDERER) \
		CONFIG_EDK2_CDK2_PS2_KEYBOARD=$(CONFIG_EDK2_CDK2_PS2_KEYBOARD) \
		CONFIG_EDK2_DISABLE_TPM=$(CONFIG_EDK2_DISABLE_TPM) \
		CONFIG_EDK2_CDK2_HPET_TIMER=$(CONFIG_EDK2_CDK2_HPET_TIMER) \
		CONFIG_MAX_CPUS=$(CONFIG_MAX_CPUS) \
		CONFIG_DRIVERS_EFI_UPDATE_CAPSULES=$(CONFIG_DRIVERS_EFI_UPDATE_CAPSULES) \
		...
		CONFIG_DRIVERS_EFI_CAPSULE_ACCEPT_EMBEDDED_DRIVERS=$(CONFIG_DRIVERS_EFI_CAPSULE_ACCEPT_EMBEDDED_DRIVERS) \
		CONFIG_DRIVERS_EFI_CAPSULE_ON_DISK_SUPPORT=$(CONFIG_DRIVERS_EFI_CAPSULE_ON_DISK_SUPPORT) \
		CONFIG_DRIVERS_EFI_GENERATE_CAPSULE=$(CONFIG_DRIVERS_EFI_GENERATE_CAPSULE) \
		CONFIG_DRIVERS_EFI_CAPSULE_EMBED_FMP_DXE=$(CONFIG_DRIVERS_EFI_CAPSULE_EMBED_FMP_DXE) \
		CONFIG_DRIVERS_EFI_CAPSULE_TRUSTED_PUBLIC_CERT=$(CONFIG_DRIVERS_EFI_CAPSULE_TRUSTED_PUBLIC_CERT) \
		CONFIG_EDK2_USE_EDK2_PLATFORMS=$(CONFIG_EDK2_USE_EDK2_PLATFORMS) \
		CONFIG_EDK2_PLATFORMS_REPOSITORY=$(CONFIG_EDK2_PLATFORMS_REPOSITORY) \
