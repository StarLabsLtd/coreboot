...
/*
 * Firmware-owned token and permissions for the settings service. Tokens are
 * stable for one firmware build. Consumers must rediscover them after every
 * firmware update and must not treat them as credentials.
 */
