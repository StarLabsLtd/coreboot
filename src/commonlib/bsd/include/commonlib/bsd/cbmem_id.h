...
#define CBMEM_ID_PAYLOAD_SPI_CONSOLE 0x434c5053 /* 'SPLC' */
...
#define CBMEM_ID_DMA_HANDOFF	0x444d4148 /* DMA protection handoff */
#define CBMEM_ID_Q35_VTD_TABLES	0x51565450 /* QEMU VT-d test tables */
#define CBMEM_ID_Q35_DMA_ARENAS	0x51444152 /* QEMU DMA test arenas */
#define CBMEM_ID_AMD_IOMMU_TABLES 0x41494d54 /* AMD IOMMU tables */
#define CBMEM_ID_AMD_IOMMU_ARENAS 0x41494d41 /* AMD IOMMU arenas */
#define CBMEM_ID_MTL_DMA_MIRROR 0x4d444d52 /* MTL DMA table mirror */
#define CBMEM_ID_MTL_MOR_COLD 0x4d4d4342 /* MTL MOR cold-boot proof */
#define CBMEM_ID_MTL_MOR_EARLY_DMA 0x4d4d4544 /* MTL MOR early DMA proof */
#define CBMEM_ID_CAPSULE_COMMUNICATION 0x4350434d /* Capsule communication */
#define CBMEM_ID_CAPSULE_STAGING 0x43505354 /* Capsule staging */
...
#define CBMEM_ID_TO_NAME_TABLE				 \
	...
	{ CBMEM_ID_PAYLOAD_SPI_CONSOLE, "PAYLOAD SPI" }, \
	...
	{ CBMEM_ID_DMA_HANDOFF,		"DMA HANDOFF"}, \
	{ CBMEM_ID_Q35_VTD_TABLES,	"Q35 VTD TAB"}, \
	{ CBMEM_ID_Q35_DMA_ARENAS,	"Q35 DMA ARE"}, \
	{ CBMEM_ID_AMD_IOMMU_TABLES,	"AMD IOMMU TB"}, \
	{ CBMEM_ID_AMD_IOMMU_ARENAS,	"AMD IOMMU AR"}, \
	{ CBMEM_ID_MTL_DMA_MIRROR,	"MTL DMA MIR"}, \
	{ CBMEM_ID_MTL_MOR_COLD,	"MTL MOR COLD"}, \
	{ CBMEM_ID_MTL_MOR_EARLY_DMA,	"MTL MOR EDMA"}, \
	{ CBMEM_ID_CAPSULE_COMMUNICATION, "CAPSULE COM"}, \
	{ CBMEM_ID_CAPSULE_STAGING,	"CAPSULE STG"}
#endif /* _CBMEM_ID_H_ */
