...
/* Bit definitions for SSFSTS_CTL (0xa0) register. */
#define SPIBAR_SSFSTS_SCIP		(1 << 0)
#define SPIBAR_SSFSTS_FDONE		(1 << 2)
...
#define SPIBAR_SSFSTS_SCF_MASK		(7 << 24)
#define SPIBAR_SSFSTS_RESERVED_MASK	0xf80081e2
#define SPIBAR_SSFSTS_W1C_BITS		(SPIBAR_SSFSTS_FDONE | \
					 SPIBAR_SSFSTS_FCERR | \
					 SPIBAR_SSFSTS_AEL)
