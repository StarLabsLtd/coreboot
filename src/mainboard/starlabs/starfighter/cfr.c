...
static uint32_t starfighter_get_object_id(void)
{
...
void lb_board(struct lb_header *header)
{
	...
	const struct sm_object device_options[] = {
		...
		SM_DECLARE_BOOL(bool_opts[9]),		// pciexp_clk_pm
		SM_DECLARE_BOOL(bool_opts[10]),		// pciexp_aspm
		SM_DECLARE_BOOL(bool_opts[11]),		// pciexp_l1_sub_state
	#endif
	};
