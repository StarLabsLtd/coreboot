...
#define WLAN_DEVFN PCIE_GPP_2_1_DEVFN
#define SD_DEVFN   PCIE_GPP_2_2_DEVFN
#define NVME0_DEVFN PCIE_GPP_2_4_DEVFN
...
#define NVME0_DXIO_DESCRIPTOR {                  \
	.engine_type = PCIE_ENGINE,              \
	.port_present = true,                    \
	.start_lane = 16,                        \
	.end_lane = 19,                          \
	.device_number = PCI_SLOT(NVME0_DEVFN),  \
	.function_number = PCI_FUNC(NVME0_DEVFN),\
