...
/*
 * Ramstage pad configuration.
 *
 * Keep this table limited to pads backed by the Y1 schematic or by obvious
 * SoC-native requirements. The older Byte variant carried a lot of guessed
 * laptop-oriented GPIO programming that does not match the Mini PC.
 */
const struct soc_amd_gpio gpio_table[] = {
	...
	/* AGPIO84:	Unused in AMI table		*/
	PAD_NC(GPIO_84),
	/* AGPIO85:	Unused in AMI table		*/
	PAD_NC(GPIO_85),
	/* AGPIO86:	EC_SMI_N			*/
