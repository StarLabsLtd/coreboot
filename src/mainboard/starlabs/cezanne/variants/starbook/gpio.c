...
const struct soc_amd_gpio gpio_table[] = {
	...
	PAD_NC(GPIO_4),
	PAD_NF(GPIO_5,		DEVSLP0,	PULL_DOWN),			// SATA_DEVSLP0
	PAD_NC(GPIO_6),
	PAD_NC(GPIO_7),
	...
	PAD_NF(GPIO_74,		LPCCLK0,	PULL_NONE),			// LPCCLK0
	PAD_NC(GPIO_75),
	PAD_NC(GPIO_76),
	PAD_NC(GPIO_84),
	PAD_NC(GPIO_85),
	...
	PAD_NF(GPIO_115,	CLK_REQ1_L,	PULL_NONE),			// PCIE_SSD_CLK_REQ_N
	PAD_NC(GPIO_116),
	PAD_NC(GPIO_120),
	PAD_NF(GPIO_121,	CLK_REQ6_L,	PULL_NONE),			// WIFI_CLK_REQ
	PAD_NC(GPIO_129),
	PAD_NC(GPIO_130),
	PAD_NC(GPIO_131),
	PAD_NC(GPIO_132),
