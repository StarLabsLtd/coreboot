...
const struct soc_amd_gpio early_gpio_table[] = {
	...
	PAD_GPO(GPIO_26,			LOW),		// PLT_RST_N
	PAD_GPO(GPIO_40,			LOW),		// SSD_RST
	PAD_CFG_STRUCT(GPIO_91, GPIO_91_IOMUX_GPIOxx, PAD_OUTPUT(LOW) | PAD_PULL(PULL_UP)),
...
const struct soc_amd_gpio gpio_table[] = {
	...
	PAD_SCI(GPIO_18,	PULL_UP,	EDGE_LOW),	// WLAN_WAKE_N
	...
	PAD_NC(GPIO_24),
	PAD_GPO(GPIO_26,			HIGH),		// PCIE_RST_L
	...
	PAD_CFG_STRUCT(GPIO_91, GPIO_91_IOMUX_GPIOxx, PAD_OUTPUT(HIGH) | PAD_PULL(PULL_UP)),
	PAD_NC(GPIO_92),
