...
const struct pad_config gpio_table[] = {
	...
	PAD_CFG_GPO(GPP_F20, 0, PLTRST),				/* Reset asserted */
	PAD_CFG_GPO(GPP_D14, 0, DEEP),					/* Enable */
	...
	PAD_CFG_NF(GPP_A14, NONE, DEEP, NF2),				/* HDMI Hot Plug */
	PAD_CFG_NF(GPP_E20, NONE, DEEP, NF1),				/* HDMI DDC Clock */
	PAD_CFG_NF(GPP_E21, NONE, DEEP, NF1),				/* HDMI DDC Data */
	...
	/* Retimer */
	PAD_CFG_NF(GPP_E18, NONE, DEEP, NF4),				/* TBT0 TXD */
	PAD_CFG_NF(GPP_E19, NONE, DEEP, NF4),				/* TBT0 RXD */
	PAD_CFG_GPO(GPP_E4, 0, DEEP),					/* Force Power */

	/* High-Definition Audio */
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_R0, NATIVE, DEEP, NF1),		/* Clock */
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_R1, NATIVE, DEEP, NF1),		/* Sync */
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_R2, NATIVE, DEEP, NF1),		/* Data Output */
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_R3, NATIVE, DEEP, NF1),		/* Data Input */
	PAD_CFG_NF_IOSTANDBY_IGNORE(GPP_R4, NATIVE, DEEP, NF1),		/* Reset */
