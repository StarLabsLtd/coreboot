...
#define STARBOOK_MTL_MOR_PRIVATE_BOUNDARY_REVISION 3U
#define STARBOOK_MTL_MOR_PRIVATE_OWNER_SIZE 32U
#define STARBOOK_MTL_MOR_PRIVATE_CALLBACK_STACK_MAX 3072U
#define STARBOOK_MTL_MOR_PRIVATE_TRANSPORT_SIZE 4096U
 ...
 * authorities. resolve() may succeed only after the loader receipt and its
 * transport-page receipt have been verified for this generation and owner.
 * It returns that exact page before a later slice may install an SMM
 * bootstrap. close() rolls back every arena_seed() attempt, including one
