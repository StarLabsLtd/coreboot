...
void devtree_update(void)
{
	...
	case PP_POWER_SAVER:
		soc_conf_20core->tdp_pl1_override	= 15;
		soc_conf_20core->tdp_pl2_override	= 15;
		common_config->pch_thermal_trip		= 30;
		break;
	case PP_BALANCED:
		soc_conf_20core->tdp_pl1_override	= 15;
		soc_conf_20core->tdp_pl2_override	= 25;
		common_config->pch_thermal_trip		= 25;
		break;
	case PP_PERFORMANCE:
		soc_conf_20core->tdp_pl1_override	= 28;
		soc_conf_20core->tdp_pl2_override	= 40;
