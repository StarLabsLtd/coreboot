...
static const struct {
	...
	{ STARLABS_EFIOPT_ID_CHARGING_POLICY, EC_ACPI_FIELD("CHGP"),
	  CONFIG(EC_STARLABS_CHARGING_POLICY) },
	{ STARLABS_EFIOPT_ID_POWER_REPORTING, EC_ACPI_FIELD("PWRP"),
	  CONFIG(EC_STARLABS_POWER_REPORTING) },
