...
romstage-$(CONFIG_PAYLOAD_MM_AUTHVAR_MOR_ENTRY_PROBE) += payload_mm_authvar_fv.c
romstage-$(CONFIG_PAYLOAD_MM_AUTHVAR_MOR_ENTRY_PROBE) += payload_mm_authvar_ftw.c
romstage-$(CONFIG_PAYLOAD_MM_AUTHVAR_MOR_ENTRY_PROBE) += payload_mm_authvar_store.c
romstage-$(CONFIG_PAYLOAD_MM_AUTHVAR_MOR_ENTRY_PROBE) += payload_mm_authvar_mor_identity.c
