...
smm-$(CONFIG_PAYLOAD_MM_AUTHVAR_STORE_SEMANTICS) += payload_mm_authvar_record.c
smm-$(CONFIG_PAYLOAD_MM_AUTHVAR_VOLATILE_VIEW) += payload_mm_authvar_view.c
smm-$(CONFIG_PAYLOAD_MM_AUTHVAR_FTW_DECODER) += payload_mm_authvar_fv.c
...
smm-$(CONFIG_PAYLOAD_MM_AUTHVAR_SMMSTORE_BACKEND) += payload_mm_authvar_smm_media_spi.c
...
smm-$(CONFIG_PAYLOAD_MM_AUTHVAR_QEMU_PFLASH_BACKEND) += payload_mm_authvar_smm_media_qemu.c
ramstage-$(CONFIG_PAYLOAD_MM_AUTHVAR_MOR_PRIVATE_SMI) += payload_mm_authvar_mor_private_smi_sender.c
...
smm-$(CONFIG_PAYLOAD_MM_FMP_OWNER_AUTHVAR_BOOT) += \
...
smm-$(CONFIG_PAYLOAD_MM_AUTHVAR_PRIVATE_BINDING) += payload_mm_authvar_private_binding.c
smm-$(CONFIG_PAYLOAD_MM_AUTHVAR_PRIVATE_TRUST) += payload_mm_authvar_private_trust.c
...
smm-$(CONFIG_PAYLOAD_MM_AUTHVAR_BUNDLE_PLAN) += payload_mm_authvar_mode.c
...
ramstage-$(CONFIG_PAYLOAD_MM_AUTHVAR_PRESENCE_HANDOFF) += \
...
ramstage-$(CONFIG_BOOTMEM_ALIGNED_RESERVATION_RECEIPT) += bootmem_reservation_receipt.c
smm-$(CONFIG_BOOTMEM_ALIGNED_RESERVATION_RECEIPT) += bootmem_reservation_receipt.c
...
romstage-$(CONFIG_PCI_BME_QUIESCE) += pci_bme_quiesce.c
ramstage-$(CONFIG_PCI_BME_QUIESCE) += pci_bme_quiesce.c
...
ramstage-$(CONFIG_PAYLOAD_DMA_HANDOFF) += dma_handoff.c
smm-y += crc_byte.c
