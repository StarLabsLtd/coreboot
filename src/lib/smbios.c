...
static bool smbios_dimm_uses_onboard_fallbacks(const struct spd_info *info)
{
	return info->form_factor == MEMORY_FORMFACTOR_CHIP ||
					 ...
					 int type16_handle)
{
	...
	bool use_onboard_fallbacks = smbios_dimm_uses_onboard_fallbacks(&info);
